...
# from myLib.nothing.cookie_refresh import *
...
import json
import time
from preserve_seat_tomorrow import usr_list
# 关闭警告
...
def all_libs_random():
    # 更新cookie
    headers['Cookie'] = usr_list[0]['cookie']
...
# 2. 针对某一个阅览室的所有座位
def typical_libs_all_seats():
    # 更新cookie
    headers['Cookie'] = usr_list[0]['cookie']
    count = 0
    print('电子阅览室:             490')
    print('多功能阅览室:            491')
    print('二楼北社会科学阅览室:  122223')
    print('二楼南报刊:           122216')
    print('三楼南自然科学阅览室:  122202')
    print('三楼北语言文学:       122265')
    print('三楼北经济管理:       122272')
    print('四楼北自然科学阅览室: 122188')
    lib_id = input('请选择阅览室，输入对应的阅览室ID：')
